...
export default {
  ...
  created() {
    // Set the inquiry ID for all resources
    this.$resources.inquiry.params.name = this.inquiryId
    this.$resources.acceptInquiry.params.name = this.inquiryId
    this.$resources.convertToDeal.params.name = this.inquiryId
  },
  resources: {
    inquiry: {
